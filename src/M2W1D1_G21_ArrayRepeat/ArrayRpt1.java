...
*/
        //ekrana yazdırma.... direk ikisini birden

        for (int satir = 0; satir <4 ; satir++) {

                for (int sutun = 0; sutun <5 ; sutun++) {

                mat[satir][sutun]=(int)(Math.random()*101); // Kullanıcıdan sayı alır gibi random sayı alınır.
