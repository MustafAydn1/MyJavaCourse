...
public class HocaninSyfsi {
    public static void main(String[] args) {
        ...
        notlarArrList.add(turNotlar);// notlaın bulundugu sayfalardan defterler hazırladık...
        notlarArrList.add(kimNotlar);//sayfalar satırları---her sayfadaki litedekilerin sayısı sutunları göstrir
