...
public class HashSet1 {
    public static void main(String[] args) {
        ...
        Set hsObject=new HashSet(); // BAŞTA VE SONDA <> YOK. dolayısıyla mezhepsiz..Herşeyi içine alır..

        // Bu tanımlamada her türlü değişken atanabilir, bütün tipler
        ...
        // 3.Yöntem Iterator
        Iterator it= hs.iterator();// hs nin başına konumlandı... BAŞLAMA
        while (it.hasNext()){// iterator un konumlandığı yere göre sonrasında eleman varsa devam et...BİTİŞ

            Integer  eleman=(Integer)it.next();// ıterator göstergesinin gösterdiği elemanları ver.... LOOP GÖVDESİ
            System.out.println("it : eleman = " + eleman);

          //  if(eleman==34);
          //  it.remove();// daha hızlı silme işlemi yapabiliyor... ?????????????????????  SORUN VAR...
